  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto">
      <GlassContainer className="flex items-center p-2">
        <input type="text" value={city} onChange={(e) => setCity(e.target.value)} placeholder="Digite a cidade..." className="flex-1 bg-transparent border-none outline-none px-4 py-2 text-white placeholder-white/60" disabled={isLoading} suppressHydrationWarning />
